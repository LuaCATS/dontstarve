...
function Physics:SetCapsule() end

function Physics:SetDamping() end

function Physics:ConstrainTo() end

function Physics:GetMotorVel() end

function Physics:GetVelocity() end

function Physics:SetCollides() end

function Physics:SetCylinder() end

function Physics:SetFriction() end

function Physics:SetMotorVel() end

function Physics:CollidesWith() end
...
function Physics:SetTriangleMesh() end
...
function Physics:SetCollisionGroup() end

function Physics:ClearCollisionMask() end

function Physics:SetMotorVelOverride() end

function Physics:SetCollisionCallback() end

function Physics:SetDontRemoveOnSleep() end
